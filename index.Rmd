...
* Установить [R/Rstudio/Latex](https://github.com/bdemeshev/em301/wiki/R); выслать (и сдать распечатанными) два файла (.Rnw и .pdf) с пятью фактами о себе и картинкой до 10:40 22 сентрября. Пример [домашнего задания от Хрюши](https://github.com/bdemeshev/em301/raw/master/2015/ht_01_hrusha/ht_01_hrusha.zip). Можно разархивировать файл, открыть .Rnw в R-studio, нажать “compile pdf”, должен получиться готовый pdf-файл.
