...
* Д.з.: установить [R/Rstudio/Latex](https://github.com/bdemeshev/em301/wiki/R); выслать (и сдать распечатанными) два файла (`.Rnw` и `.pdf`) с пятью фактами о себе и картинкой до 10:40 22 сентября.
