...
#### 08 сентября 2015
1. Метод наименьших квадратов: оценка моделей зависимости роста от веса и погоды на улице (без параметра).
2. Оценка моделей зависимости роста от веса с помощбю МНК в R.

Д.з.

1. Темы первой к.р.: скалярное произведение и его связь с косинусом угла, т. Пифагора, т. о трех перпендикулярах; проверка гипотезы о среднем, уровень значимости, p-value, доверительные интервалы; свойства м.о., дисперсии, условная вероятность; умножение, обращение, транспонирование матриц, определитель и след матрицы, их связь с собственными значениями; det(A)=a, det(B)=b, det(A*B) - ?.
2. Установить R/Rstudio/Latex; выслать (и сдать распечатанными) два файла (.Rnw и .pdf) с пятью фактами о себе и картинкой до 10:40 22 сентрября.
