...
* Проверка несмещенности оценок (2.6). Дисперсия и свойства оценки параметра <i>&#946;<sub>2</sub><i> (2.17).
* Д.з.: с прошлого семинара (4.16, 4.21, 4.22, 4.25, 4.26, 1.15, 1.20) + минимум (Белая роза) + дополнительно (Алая Роза).
