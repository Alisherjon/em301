...
* Через неделю (26 февраля) --- <b>контрольная</b>. Темы: ML, LR, LM, тест Вальда, логит- и пробит-модели.

#### Титаник
* Дедлайн --- 15 апреля, 02:20.
* Зарегистрироваться на [kaggle](https://www.kaggle.com) и посмотреть, сколько там всего интересного.
* Подать заявку на участие в [Титанике](https://www.kaggle.com/c/titanic).
* (подробное руководство к действию будет позже, но задание мало изменится по сравнению с прошлыми годами)
